...
CGUI::CGUI()
{
	...
	//LoadTextureFromDB& style = ImGui::GetStyle();
...
void CGUI::RenderPosition()
{
    ...
    const char *buildString = "Native Build: " __DATE__ " " __TIME__ " Client VO Version: 1.95 BETA-TEST chat and keyboard and radar";
	...
	sprintf(text3, "Streamed Peds: %d\nStreamed Vehicles: %d", uiStreamedPeds, uiStreamedVehicles);
...
void CGUI::RenderGUI()
{
	...
	RenderText(verpos, ImColor(0xFFFFFFFF), true, "VOLGA ONLINE | v129"); }*/
}
