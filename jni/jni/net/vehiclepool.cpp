...
bool CVehiclePool::New(NEW_VEHICLE *pNewVehicle)
{
	...
	switch (random)
	{
		case 0:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "e122ee", "52");
			break;
		}
		case 1:
		{
		...
		case 7:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "e578ee", "763");
			break;
		}
		case 8:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "a782ee", "63");
			break;
		}
		case 9:
		{
