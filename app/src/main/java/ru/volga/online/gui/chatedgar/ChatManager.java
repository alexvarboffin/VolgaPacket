package ru.volga.online.gui.chatedgar;
...
public class ChatManager {
    ...
    public final void ChatOpen(){
        ...
        KeyBoard0.getKeyBoard().openKeyBoard(null);
