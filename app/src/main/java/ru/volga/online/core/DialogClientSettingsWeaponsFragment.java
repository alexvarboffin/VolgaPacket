...
import ru.volga.launcher.fragment.BaseFragment;
import ru.volga.online.R;

public class DialogClientSettingsWeaponsFragment extends BaseFragment implements ISaveableFragment {
    ...
    private void makeAllElementsInvisible(ViewGroup parent, View notVisible, boolean first)
    {
        if(first)
        {
            ...
            mOldDrawables.put(parent, parent.getBackground());
        ...
        for(int i = 0; i < parent.getChildCount(); i++)
        {
            ...
            if(view instanceof ViewGroup)
            {
                ...
                mOldDrawables.put((ViewGroup)view, view.getBackground());
    ...
    private void makeAllElementsVisible(ViewGroup parent, View notVisible, boolean first)
    {
        if(first)
        {
            ...
            while(myVeryOwnIterator.hasNext())
            {
                ...
                Drawable value= mOldDrawables.get(key);
    ...
    private void setSeekBarListeners()
    {
        mListenerSeekBars = new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                makeAllElementsInvisible(mParentView, seekBar, true);
            }

            @Override
            public void onStopTrackingTouch(SeekBar seekBar)
            {
                makeAllElementsVisible(mParentView, seekBar, true);
    ...
    public void passValuesToNative()
    {
        for(int i = DialogClientSettings.mSettingsWeaponsStart; i < DialogClientSettings.mSettingsWeaponsEnd; i++)
        {
            ...
            NvEventQueueActivity.setNativeHudElementPosition(i, x, y);
        }
        ...
        for(int i = DialogClientSettings.mSettingsWeaponsStart; i < DialogClientSettings.mSettingsWeaponsEnd; i++)
        {
            ...
            NvEventQueueActivity.setNativeHudElementScale(i, x, y);
        }
    }
}
